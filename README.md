...
Shared schema-serialization plumbing for Eignex libraries (kumulant, klause, combo). Format-agnostic core: Named entries, a LiveSchema property-delegate builder with reentrant skeleton mode, a SchemaJson configuration with the standard @type discriminator, and a bindTyped round-trip helper. Works with any kotlinx.serialization SerialFormat; binary formats use tag numbers instead of @type.
